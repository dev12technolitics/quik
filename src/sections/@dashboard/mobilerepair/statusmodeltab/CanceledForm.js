...
export default function CanceledForm({ id, onCancel }) {
    ...
    const NewProductSchema = Yup.object().shape({
        canceled_comment: Yup.string().required('Comment is required'),
    });
        ...
        <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)} >
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={12} >
                    <Box sx={{ ml: 3, mr: 3 }}>
                        <RHFTextField name="canceled_comment" multiline rows={3} label="Comment" />
