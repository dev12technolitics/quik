...
const TABLE_HEAD = [
    ...
    { id: 'city_name', label: 'Name of city', align: 'left' },
    { id: '', label: 'Status', align: 'left' },
    { id: '' },
];

City.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
...
export default function City() {
    ...
    const { isLoading, allCity } = useSelector((state) => state?.city);
